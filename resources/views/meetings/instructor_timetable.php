...
<script>
    ...
    var $popover = $('.instructor').find('.scheduleform');
    if ($popover.length > 0) {
        $('.instructor').find('.scheduleform').popover({
            ...
            var duration = $('.instructor').find('#duration').val();
            var venue = $('.instructor').find('#venue').val();
            $.ajaxSetup({
                headers: {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (data.conflict){
                        $('.instructor').find('#status').html(data.conflict);
                    }
                    if (data.success){
                        $('.instructor').find('#status').html(data.success);
                    }
                },
    ...
    $('.nextweek').on('click', function () {
        ...
        $.ajax({
            ...
            data: {
                monday: $('.instructor').find('#monday').val(),
                tuesday: $('.instructor').find('#tuesday').val(),
                wednesday: $('.instructor').find('#wednesday').val(),
                thursday: $('.instructor').find('#thursday').val(),
                friday: $('.instructor').find('#friday').val(),
                button: 'next',
                id:<?=$id?>,
                type: 'instructor'
            },
