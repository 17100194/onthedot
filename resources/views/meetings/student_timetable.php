...
<script>
    ...
    var $popover = $('.student').find('.scheduleform');
    if ($popover.length > 0) {
        $('.student').find('.scheduleform').popover({
            ...
            $.ajax({
                ...
                beforeSend: function() {
                    ...
                    $('.help-block').remove();
                    $('.student').find('#status').html('<div class="text-center">Processing</div><img src="<?=asset('public/images/preloader.gif')?>" class="center-block">');
                },
                success: function(data) {
                    $('.student').find('#status').html('');
                    ...
                    if (data.conflict){
                        $('.student').find('#status').html(data.conflict);
                    }
                    if (data.success){
                        $('.student').find('#status').html(data.success);
                    }
                },
    ...
    $('.nextweek').on('click', function () {
        ...
        $.ajax({
            ...
            data: {
                monday: $('.student').find('#monday').val(),
                tuesday: $('.student').find('#tuesday').val(),
                wednesday: $('.student').find('#wednesday').val(),
                thursday: $('.student').find('#thursday').val(),
                friday: $('.student').find('#friday').val(),
                button: 'next',
                id:<?=$id?>,
                type: 'student'
            },
