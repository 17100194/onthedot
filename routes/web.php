...
Route::get('/course/edit/{id}', 'CourseController@editCourse')->middleware('auth','minify');
Route::post('/course/update', 'CourseController@updateCourse')->middleware('auth','minify');
...
Route::get('/course/make', 'CourseController@makeform')->middleware('auth','minify');
Route::get('/course/enroll', 'CourseController@enroll')->middleware('auth','minify');
Route::post('/addcourse', 'CourseController@addcourse')->middleware('auth','minify');
Route::get('/course/searchcourse', 'CourseController@searchcourse')->middleware('auth','minify');
Route::post('/course/enrollcourse', 'CourseController@enrollcourse')->middleware('auth','minify');
...
Route::get('/course/all', 'CourseController@all')->middleware('auth','minify');
...
Route::post('/course/dropcourse', 'CourseController@dropCourse')->middleware('auth','minify');
Route::post('dropcourse', 'CourseController@dropCourse')->middleware('auth','minify');
...
Route::get('/course/coursedetails', 'CourseController@courseDetails')->middleware('auth','minify');
